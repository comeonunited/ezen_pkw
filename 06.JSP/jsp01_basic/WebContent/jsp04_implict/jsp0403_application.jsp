...
<body>
	<h3>3. ServletContext(application) 기본객체</h3>
	<%
	...
	서블릿규약메이저정보 : <%= application.getMajorVersion() %><br>
	서블릿규약마이너정보 : <%= application.getMinorVersion() %><br>

	<h4>로그메시지기록</h4>
	<%
		application.log("테스트 로그메시지를 기록합니다...");
		log("로그메시지기록-log");
	%>
</body>
</html>